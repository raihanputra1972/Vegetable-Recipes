    ...
    <div className="home">
      <div className="hero">
        ...
        <div className="title">
          ...
          <h3>
            Vegetarian food is a type of food made from plant-based sources
            without the inclusion of meat, fish, or other animal products.
          </h3>
        </div>
      </div>
      <div className="recipe-categories">
        <div className="recipe-categories-title">
          ...
          <h2>
            You can choose recipes based on your preferences more easily with
            categories
          </h2>
        </div>
        <div className="cards">
